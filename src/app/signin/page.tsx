...
const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="24px" height="24px" {...props}>
        ...
        f<path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571l6.19,5.238C44.904,36.336,48,30.651,48,24C48,22.659,47.862,21.35,47.611,20.083z"/>
    </svg>
);
...
export default function SignInPage() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      // This will only be called after a successful login.
      if(result.user) {
        router.push('/dashboard');
      }
    } catch (error: any) {
