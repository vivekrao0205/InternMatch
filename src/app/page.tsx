...
const features = [
  ...
  },
  {
    ...
    description: 'Explore a wide range of internships and filter them to fit your needs.',
  },
  {
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="space-y-6 max-w-2xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground">
              Leverage the power of AI to connect with top tech companies and launch your career. Your dream internship is just a match away.
            </p>
      ...
      <section className="py-20 md:py-24 bg-card">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground mt-4 max-w-2xl mx-auto">
            Join a growing community of students. Create your profile today and let opportunity find you.
          </p>
